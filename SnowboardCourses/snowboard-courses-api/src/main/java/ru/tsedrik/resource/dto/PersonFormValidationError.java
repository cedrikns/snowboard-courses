 ...
 */
@ApiModel(description = "Модель для ответа в результате ошибок при валидации формы Person")
public class PersonFormValidationError {
     ...
     */
    @ApiModelProperty(value = "Код исключения, в результате которого был создан данный объект", example = "personFormValidationException", required = true)
